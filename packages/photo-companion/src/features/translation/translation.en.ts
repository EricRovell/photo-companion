...
export const t = {
	...
	MESSAGE: {
		...
		LIGHTS_CONTINUOUS_DARKNESS: "The Sun stays below the switching threshold; lights are estimated to remain on.",
		LIGHTS_CONTINUOUS_DAYLIGHT: "The Sun stays above the switching threshold; lights are estimated to remain off.",
		LIGHTS_SCHEDULE_UNAVAILABLE: "No lights estimate is available for this date.",
