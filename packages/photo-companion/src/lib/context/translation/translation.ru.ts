...
export const t = {
	...
	ERRORS: {
		...
		LATITUDE: "Значение широты должно быть в диапазоне от -90 до 90",
		...
		LONGITUDE: "Значение долготы должно быть в диапазоне от -180 до 180",
		...
		SUN_IS_BELOW: "Солнце ниже горизонта"
	},
	LABEL: {
