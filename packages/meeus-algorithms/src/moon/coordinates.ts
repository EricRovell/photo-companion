import { Sun } from "../../sun";
import { DEG2RAD, RAD2DEG } from "../consts";
import { transformEclipticToEquatorial } from "../coordinates";
import { getMeanObliquityOfEcliptic, getNutationInLongitude, getTrueObliquityOfEcliptic } from "../nutation";
import { Obliquity } from "../types";
import { getJulianCentury } from "../utils/julian-day";
import { fmod360 } from "../utils/math";
import { getCoefficients1, getCoefficients2, getCoefficients3, getCoefficients4 } from "./consts";
import { getSigma } from "./reducers";

import type { CoordinatesEcliptic, Degree, EquatorialCoordinates, JulianDay, Kilometer} from "../types";
 ...
 * @memberof module:Earth
 */
export function getGeocentricCoordinatesEcliptic (jd: JulianDay): CoordinatesEcliptic {
	return {
...
export function getGeocentricEquatorialCoordinates (jd: JulianDay, obliquity: Obliquity = Obliquity.Mean): EquatorialCoordinates {
	return transformEclipticToEquatorial(
		getGeocentricCoordinatesEcliptic(jd),
...
export function getApparentGeocentricEquatorialCoordinates (jd: JulianDay): EquatorialCoordinates {
	const ecliptic = getGeocentricCoordinatesEcliptic(jd);
...
/**
 * Radius vector (distance Earth-Moon)
 */
