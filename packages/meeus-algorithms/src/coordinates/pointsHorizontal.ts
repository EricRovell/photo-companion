...
import type { CoordinatesHorizontal, Point } from "../types";
 ...
 */
export function transformPointToHorizontal (point: Point, center: Point, radius: number): CoordinatesHorizontal {
 ...
 * @returns {Point}
 */
export function transformHorizontalToPoint (horCoords: CoordinatesHorizontal, center: Point, radius: number): Point {
