<script lang="ts">
	...
	switch (event) {
		...
		case "sunrise:end":
			color = "#9C4438";
			break;
		case "dawn:golden-hour:end":
			color = "#EC8F12";
			break;
		case "solar-noon":
			color = "gold";
			break;
		case "dusk:golden-hour:start":
			color = "#EC8F12";
			break;
		case "sunset:start":
		case "sunset:end":
